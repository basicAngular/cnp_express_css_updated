...
Route::group(array('middleware' => ['sentinel', 'authorized', 'xss_protection'], 'namespace' => 'Users'), function () {
    ...
    Route::group(['prefix' => 'broker'], function () {
        Route::get('data', 'BrokerController@data');
        Route::get('{broker}/show', 'BrokerController@show');
        Route::get('{broker}/delete', 'BrokerController@delete');
        Route::get('invite', 'BrokerController@invite');
        Route::post('invite', 'BrokerController@inviteSave');
        Route::get('invite/{id}/cancel', 'BrokerController@inviteCancel');
        Route::post('invite/{id}/cancel-invite','BrokerController@inviteCancelConfirm');
    });
